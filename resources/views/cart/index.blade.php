                        ...
                        <div class="order-block__type">
                            <div class="radios-type">
                                <label class="radios-type__label">
                                    <input class="radios-type__input" type="radio" name="delivery" value="1" @click="delivery = true" checked>
                                    <span class="radios-type__text">С доставкой</span>
                                </label>
                                <label class="radios-type__label">
                                    <input class="radios-type__input" type="radio" name="delivery" value="0" @click="delivery = false">
                            ...
                            <div class="order-block__grid">
                                ...
                                <div class="order-block__col-4" x-show="delivery" x-transition.duration.500ms>
                                    <label class="label-form">
                                        ...
                                        <input class="label-form__input" type="text" name="apartment_number" placeholder="Введите номер квартиры" :required="delivery" autocomplete="off">
                                    </label>
                                </div>
